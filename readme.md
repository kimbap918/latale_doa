## 라테일 코디 시뮬레이터 doa_latte

## (중요) 공지

⚠️ 리소스 암호화로 인해 도아라떼가 완전히 기능을 정지하여 새롭게 툴을 개발했습니다. <br>
아래 툴을 사용해주시면 감사하겠습니다.

https://github.com/kimbap918/Latte_1
...
3. 현재 사용중인 라테일의 클라이언트를 후킹합니다. 만약 바로 실행이 된다면 설정값에 의해 자동으로 후킹이 된거니 이 절차를 무시하셔도 됩니다! <br>
라테일 클라이언트는 라테일을 설치한 C드라이브 혹은 D드라이브의 games 폴더 -> Actoz 폴더 -> LaTale 폴더 -> LataleClient.exe를 선택하면 됩니다.
...
6. Load를 눌러 캐릭터의 데이터 값이 든 프리셋을 가져옵니다.
